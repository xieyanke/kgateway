...
import (
	...
	envoytrace_gloo "github.com/kgateway-dev/kgateway/v2/pkg/gloo/pkg/api/external/envoy/config/trace/v3"
	gloov1 "github.com/kgateway-dev/kgateway/v2/pkg/gloo/pkg/api/v1"
	"github.com/kgateway-dev/kgateway/v2/pkg/gloo/pkg/api/v1/options/hcm"
	"github.com/kgateway-dev/kgateway/v2/pkg/gloo/pkg/api/v1/options/headers"
	static_plugin_gloo "github.com/kgateway-dev/kgateway/v2/pkg/gloo/pkg/api/v1/options/static"
	"github.com/kgateway-dev/kgateway/v2/pkg/gloo/pkg/api/v1/options/tracing"
