...
import (
	...
	v1 "github.com/kgateway-dev/kgateway/v2/pkg/gloo/pkg/api/v1/enterprise/options/extauth/v1"
	bootstrap "github.com/kgateway-dev/kgateway/v2/pkg/gloo/pkg/bootstrap/clients"
