...
import (
	...
	defaults2 "github.com/kgateway-dev/kgateway/v2/pkg/gateway/pkg/defaults"
	...
	"github.com/kgateway-dev/kgateway/v2/pkg/gloo/pkg/api/v1/options/dynamic_forward_proxy"
