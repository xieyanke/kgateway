...
import (
	...
	"github.com/kgateway-dev/kgateway/v2/pkg/gloo/pkg/api/v1/options/healthcheck"
	routerV1 "github.com/kgateway-dev/kgateway/v2/pkg/gloo/pkg/api/v1/options/router"
	static_plugin_gloo "github.com/kgateway-dev/kgateway/v2/pkg/gloo/pkg/api/v1/options/static"
	"github.com/kgateway-dev/kgateway/v2/pkg/gloo/pkg/api/v1/options/stats"
