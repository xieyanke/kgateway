...
import (
	...
	github_com_solo_io_gloo_projects_controller_pkg_api_v1_core_selectors "github.com/solo-io/gloo/projects/controller/pkg/api/v1/core/selectors"
...
func (m *Gateway) Clone() proto.Message {
	...
	if h, ok := interface{}(m.GetRouteOptions()).(clone.Cloner); ok {
		target.RouteOptions = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1.RouteConfigurationOptions)
	} else {
		target.RouteOptions = proto.Clone(m.GetRouteOptions()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1.RouteConfigurationOptions)
	}
...
func (m *TcpGateway) Clone() proto.Message {
	...
	if m.GetTcpHosts() != nil {
		target.TcpHosts = make([]*github_com_solo_io_gloo_projects_controller_pkg_api_v1.TcpHost, len(m.GetTcpHosts()))
		for idx, v := range m.GetTcpHosts() {

			if h, ok := interface{}(v).(clone.Cloner); ok {
				target.TcpHosts[idx] = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1.TcpHost)
			} else {
				target.TcpHosts[idx] = proto.Clone(v).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1.TcpHost)
			}
	...
	if h, ok := interface{}(m.GetOptions()).(clone.Cloner); ok {
		target.Options = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1.TcpListenerOptions)
	} else {
		target.Options = proto.Clone(m.GetOptions()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1.TcpListenerOptions)
	}
	...
	case *DelegatedHttpGateway_Selector:
		...
		if h, ok := interface{}(m.GetSelector()).(clone.Cloner); ok {
			target.SelectionType = &DelegatedHttpGateway_Selector{
				Selector: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_core_selectors.Selector),
			}
		} else {
			target.SelectionType = &DelegatedHttpGateway_Selector{
				Selector: proto.Clone(m.GetSelector()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_core_selectors.Selector),
			}
		}
