...
func (SocketOption_SocketState) Descriptor() protoreflect.EnumDescriptor {
	return file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_enumTypes[0].Descriptor()
}

func (SocketOption_SocketState) Type() protoreflect.EnumType {
	return &file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_enumTypes[0]
}
...
func (SocketOption_SocketState) EnumDescriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_rawDescGZIP(), []int{0, 0}
}
...
func (x *SocketOption) Reset() {
	*x = SocketOption{}
	mi := &file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_msgTypes[0]
...
func (*SocketOption) Descriptor() ([]byte, []int) {
	return file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_rawDescGZIP(), []int{0}
}
...
var File_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto protoreflect.FileDescriptor

var file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_rawDesc = []byte{
	...
	0x76, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x03, 0xf8, 0x42, 0x01, 0x42, 0xa8, 0x01, 0xb8, 0xf5, 0x04,
	...
	0x6f, 0x6e, 0x66, 0x69, 0x67, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x76, 0x33, 0x42, 0x11, 0x53,
	0x6f, 0x63, 0x6b, 0x65, 0x74, 0x4f, 0x70, 0x74, 0x69, 0x6f, 0x6e, 0x50, 0x72, 0x6f, 0x74, 0x6f,
...
var (
	file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_rawDescOnce sync.Once
	file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_rawDescData = file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_rawDesc
)

func file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_rawDescGZIP() []byte {
	file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_rawDescOnce.Do(func() {
		file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_rawDescData = protoimpl.X.CompressGZIP(file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_rawDescData)
	})
...
var file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_enumTypes = make([]protoimpl.EnumInfo, 1)
var file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_msgTypes = make([]protoimpl.MessageInfo, 1)
var file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_goTypes = []any{
...
var file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_depIdxs = []int32{
...
func file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_init() {
	if File_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto != nil {
		return
	}
	file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_msgTypes[0].OneofWrappers = []any{
	...
	File_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto = out.File
	file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_rawDesc = nil
	file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_goTypes = nil
	file_github_com_solo_io_gloo_projects_controller_api_external_envoy_config_core_v3_socket_option_proto_depIdxs = nil
}
