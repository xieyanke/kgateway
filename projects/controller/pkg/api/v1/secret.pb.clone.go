	...
	case *Secret_Oauth:
		...
		if h, ok := interface{}(m.GetOauth()).(clone.Cloner); ok {
			target.Kind = &Secret_Oauth{
				Oauth: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_extauth_v1.OauthSecret),
			}
		} else {
			target.Kind = &Secret_Oauth{
				Oauth: proto.Clone(m.GetOauth()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_extauth_v1.OauthSecret),
			}
		}
	...
	case *Secret_ApiKey:
		...
		if h, ok := interface{}(m.GetApiKey()).(clone.Cloner); ok {
			target.Kind = &Secret_ApiKey{
				ApiKey: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_extauth_v1.ApiKey),
			}
		} else {
			target.Kind = &Secret_ApiKey{
				ApiKey: proto.Clone(m.GetApiKey()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_extauth_v1.ApiKey),
			}
		}
