...
// source: github.com/solo-io/gloo/projects/controller/api/v1/virtual_host_options.proto
...
import (
	...
	github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_stats "github.com/solo-io/gloo/projects/controller/pkg/api/v1/options/stats"
...
func (m *VirtualHostOptions) Clone() proto.Message {
	...
	if h, ok := interface{}(m.GetStats()).(clone.Cloner); ok {
		target.Stats = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_stats.Stats)
	} else {
		target.Stats = proto.Clone(m.GetStats()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_stats.Stats)
	}
	...
	if h, ok := interface{}(m.GetCorsPolicyMergeSettings()).(clone.Cloner); ok {
		target.CorsPolicyMergeSettings = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_cors.CorsPolicyMergeSettings)
	} else {
		target.CorsPolicyMergeSettings = proto.Clone(m.GetCorsPolicyMergeSettings()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_cors.CorsPolicyMergeSettings)
	}
	...
	case *VirtualHostOptions_RatelimitEarly:
		...
		if h, ok := interface{}(m.GetRatelimitEarly()).(clone.Cloner); ok {
			target.RateLimitEarlyConfigType = &VirtualHostOptions_RatelimitEarly{
				RatelimitEarly: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitVhostExtension),
			}
		} else {
			target.RateLimitEarlyConfigType = &VirtualHostOptions_RatelimitEarly{
				RatelimitEarly: proto.Clone(m.GetRatelimitEarly()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitVhostExtension),
			}
		}
	...
	case *VirtualHostOptions_Ratelimit:
		...
		if h, ok := interface{}(m.GetRatelimit()).(clone.Cloner); ok {
			target.RateLimitConfigType = &VirtualHostOptions_Ratelimit{
				Ratelimit: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitVhostExtension),
			}
		} else {
			target.RateLimitConfigType = &VirtualHostOptions_Ratelimit{
				Ratelimit: proto.Clone(m.GetRatelimit()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitVhostExtension),
			}
		}
	...
	case *VirtualHostOptions_RatelimitRegular:
		...
		if h, ok := interface{}(m.GetRatelimitRegular()).(clone.Cloner); ok {
			target.RateLimitRegularConfigType = &VirtualHostOptions_RatelimitRegular{
				RatelimitRegular: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitVhostExtension),
			}
		} else {
			target.RateLimitRegularConfigType = &VirtualHostOptions_RatelimitRegular{
				RatelimitRegular: proto.Clone(m.GetRatelimitRegular()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitVhostExtension),
			}
		}
	...
	case *VirtualHostOptions_Jwt:
		...
		if h, ok := interface{}(m.GetJwt()).(clone.Cloner); ok {
			target.JwtConfig = &VirtualHostOptions_Jwt{
				Jwt: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_jwt.VhostExtension),
			}
		} else {
			target.JwtConfig = &VirtualHostOptions_Jwt{
				Jwt: proto.Clone(m.GetJwt()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_jwt.VhostExtension),
			}
		}
