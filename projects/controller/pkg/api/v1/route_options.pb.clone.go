...
import (
	...
	github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_jwt "github.com/solo-io/gloo/projects/controller/pkg/api/v1/enterprise/options/jwt"
	...
	github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_cors "github.com/solo-io/gloo/projects/controller/pkg/api/v1/options/cors"

	github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_faultinjection "github.com/solo-io/gloo/projects/controller/pkg/api/v1/options/faultinjection"
	...
	github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_lbhash "github.com/solo-io/gloo/projects/controller/pkg/api/v1/options/lbhash"
	...
	github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_retries "github.com/solo-io/gloo/projects/controller/pkg/api/v1/options/retries"

	github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_shadowing "github.com/solo-io/gloo/projects/controller/pkg/api/v1/options/shadowing"
...
func (m *RouteOptions) Clone() proto.Message {
	...
	if h, ok := interface{}(m.GetFaults()).(clone.Cloner); ok {
		target.Faults = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_faultinjection.RouteFaults)
	} else {
		target.Faults = proto.Clone(m.GetFaults()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_faultinjection.RouteFaults)
	}
	...
	if h, ok := interface{}(m.GetRetries()).(clone.Cloner); ok {
		target.Retries = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_retries.RetryPolicy)
	} else {
		target.Retries = proto.Clone(m.GetRetries()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_retries.RetryPolicy)
	}
	...
	if h, ok := interface{}(m.GetTracing()).(clone.Cloner); ok {
		target.Tracing = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_tracing.RouteTracingSettings)
	} else {
		target.Tracing = proto.Clone(m.GetTracing()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_tracing.RouteTracingSettings)
	}

	if h, ok := interface{}(m.GetShadowing()).(clone.Cloner); ok {
		target.Shadowing = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_shadowing.RouteShadowing)
	} else {
		target.Shadowing = proto.Clone(m.GetShadowing()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_shadowing.RouteShadowing)
	}
	...
	if h, ok := interface{}(m.GetCors()).(clone.Cloner); ok {
		target.Cors = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_cors.CorsPolicy)
	} else {
		target.Cors = proto.Clone(m.GetCors()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_cors.CorsPolicy)
	}

	if h, ok := interface{}(m.GetLbHash()).(clone.Cloner); ok {
		target.LbHash = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_lbhash.RouteActionHashConfig)
	} else {
		target.LbHash = proto.Clone(m.GetLbHash()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_options_lbhash.RouteActionHashConfig)
	}
	...
	if h, ok := interface{}(m.GetRatelimitBasic()).(clone.Cloner); ok {
		target.RatelimitBasic = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.IngressRateLimit)
	} else {
		target.RatelimitBasic = proto.Clone(m.GetRatelimitBasic()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.IngressRateLimit)
	}
	...
	if h, ok := interface{}(m.GetRbac()).(clone.Cloner); ok {
		target.Rbac = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_rbac.ExtensionSettings)
	} else {
		target.Rbac = proto.Clone(m.GetRbac()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_rbac.ExtensionSettings)
	}
	...
	if h, ok := interface{}(m.GetDlp()).(clone.Cloner); ok {
		target.Dlp = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_dlp.Config)
	} else {
		target.Dlp = proto.Clone(m.GetDlp()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_dlp.Config)
	}
	...
	if h, ok := interface{}(m.GetExtProc()).(clone.Cloner); ok {
		target.ExtProc = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_extproc.RouteSettings)
	} else {
		target.ExtProc = proto.Clone(m.GetExtProc()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_extproc.RouteSettings)
	}

	if h, ok := interface{}(m.GetAi()).(clone.Cloner); ok {
		target.Ai = h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ai.RouteSettings)
	} else {
		target.Ai = proto.Clone(m.GetAi()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ai.RouteSettings)
	}
	...
	case *RouteOptions_HostRewritePathRegex:
		...
		if h, ok := interface{}(m.GetHostRewritePathRegex()).(clone.Cloner); ok {
			target.HostRewriteType = &RouteOptions_HostRewritePathRegex{
				HostRewritePathRegex: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_external_envoy_type_matcher_v3.RegexMatchAndSubstitute),
			}
		} else {
			target.HostRewriteType = &RouteOptions_HostRewritePathRegex{
				HostRewritePathRegex: proto.Clone(m.GetHostRewritePathRegex()).(*github_com_solo_io_gloo_projects_controller_pkg_api_external_envoy_type_matcher_v3.RegexMatchAndSubstitute),
			}
		}
	...
	case *RouteOptions_RatelimitEarly:
		...
		if h, ok := interface{}(m.GetRatelimitEarly()).(clone.Cloner); ok {
			target.RateLimitEarlyConfigType = &RouteOptions_RatelimitEarly{
				RatelimitEarly: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitRouteExtension),
			}
		} else {
			target.RateLimitEarlyConfigType = &RouteOptions_RatelimitEarly{
				RatelimitEarly: proto.Clone(m.GetRatelimitEarly()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitRouteExtension),
			}
		}
	...
	case *RouteOptions_RateLimitEarlyConfigs:
		...
		if h, ok := interface{}(m.GetRateLimitEarlyConfigs()).(clone.Cloner); ok {
			target.RateLimitEarlyConfigType = &RouteOptions_RateLimitEarlyConfigs{
				RateLimitEarlyConfigs: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitConfigRefs),
			}
		} else {
			target.RateLimitEarlyConfigType = &RouteOptions_RateLimitEarlyConfigs{
				RateLimitEarlyConfigs: proto.Clone(m.GetRateLimitEarlyConfigs()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitConfigRefs),
			}
		}
	...
	case *RouteOptions_Ratelimit:
		...
		if h, ok := interface{}(m.GetRatelimit()).(clone.Cloner); ok {
			target.RateLimitConfigType = &RouteOptions_Ratelimit{
				Ratelimit: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitRouteExtension),
			}
		} else {
			target.RateLimitConfigType = &RouteOptions_Ratelimit{
				Ratelimit: proto.Clone(m.GetRatelimit()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitRouteExtension),
			}
		}
	...
	case *RouteOptions_RateLimitConfigs:
		...
		if h, ok := interface{}(m.GetRateLimitConfigs()).(clone.Cloner); ok {
			target.RateLimitConfigType = &RouteOptions_RateLimitConfigs{
				RateLimitConfigs: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitConfigRefs),
			}
		} else {
			target.RateLimitConfigType = &RouteOptions_RateLimitConfigs{
				RateLimitConfigs: proto.Clone(m.GetRateLimitConfigs()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitConfigRefs),
			}
		}
	...
	case *RouteOptions_RatelimitRegular:
		...
		if h, ok := interface{}(m.GetRatelimitRegular()).(clone.Cloner); ok {
			target.RateLimitRegularConfigType = &RouteOptions_RatelimitRegular{
				RatelimitRegular: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitRouteExtension),
			}
		} else {
			target.RateLimitRegularConfigType = &RouteOptions_RatelimitRegular{
				RatelimitRegular: proto.Clone(m.GetRatelimitRegular()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitRouteExtension),
			}
		}
	...
	case *RouteOptions_RateLimitRegularConfigs:
		...
		if h, ok := interface{}(m.GetRateLimitRegularConfigs()).(clone.Cloner); ok {
			target.RateLimitRegularConfigType = &RouteOptions_RateLimitRegularConfigs{
				RateLimitRegularConfigs: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitConfigRefs),
			}
		} else {
			target.RateLimitRegularConfigType = &RouteOptions_RateLimitRegularConfigs{
				RateLimitRegularConfigs: proto.Clone(m.GetRateLimitRegularConfigs()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_ratelimit.RateLimitConfigRefs),
			}
		}
	...
	case *RouteOptions_Jwt:
		...
		if h, ok := interface{}(m.GetJwt()).(clone.Cloner); ok {
			target.JwtConfig = &RouteOptions_Jwt{
				Jwt: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_jwt.RouteExtension),
			}
		} else {
			target.JwtConfig = &RouteOptions_Jwt{
				Jwt: proto.Clone(m.GetJwt()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_jwt.RouteExtension),
			}
		}
	...
	case *RouteOptions_JwtStaged:
		...
		if h, ok := interface{}(m.GetJwtStaged()).(clone.Cloner); ok {
			target.JwtConfig = &RouteOptions_JwtStaged{
				JwtStaged: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_jwt.JwtStagedRouteExtension),
			}
		} else {
			target.JwtConfig = &RouteOptions_JwtStaged{
				JwtStaged: proto.Clone(m.GetJwtStaged()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_jwt.JwtStagedRouteExtension),
			}
		}
	...
	case *RouteOptions_JwtProvidersStaged:
		...
		if h, ok := interface{}(m.GetJwtProvidersStaged()).(clone.Cloner); ok {
			target.JwtConfig = &RouteOptions_JwtProvidersStaged{
				JwtProvidersStaged: h.Clone().(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_jwt.JwtStagedRouteProvidersExtension),
			}
		} else {
			target.JwtConfig = &RouteOptions_JwtProvidersStaged{
				JwtProvidersStaged: proto.Clone(m.GetJwtProvidersStaged()).(*github_com_solo_io_gloo_projects_controller_pkg_api_v1_enterprise_options_jwt.JwtStagedRouteProvidersExtension),
			}
		}
